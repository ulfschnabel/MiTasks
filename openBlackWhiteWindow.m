%% Basics
bgfactor = input('Enter starting bg color multiplier \n');
...
rdurleft = uicontrol('Style', 'edit' , 'Position', [75 10 30 20], 'String', '100');
...
uicontrol('Style', 'text', 'Position', [60 150 30 20], 'String', 'black');
uicontrol('Style', 'text', 'Position', [120 150 30 20], 'String', 'white');
