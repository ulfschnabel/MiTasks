...
specialrdurleft = uicontrol('Style', 'edit' , 'Position', [75 40 30 20], 'String', '150');
specialrdurright = uicontrol('Style', 'edit' , 'Position', [110 40 30 20], 'String', '157');
...
uicontrol('Style', 'text', 'Position', [120 150 30 20], 'String', 'Spec');
