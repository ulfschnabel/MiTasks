...
rdurright = uicontrol('Style', 'edit' , 'Position', [110 10 30 20], 'String', '100'); %19112013: gives 0.6ml per 100 hits
...
pdbox = uicontrol('Style', 'edit' , 'Position', [270 170 20 20], 'String', '50');
drawnow